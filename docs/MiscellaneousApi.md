...
api_instance = gitea_client.MiscellaneousApi(gitea_client.ApiClient(configuration))
...
# create an instance of the API class
api_instance = gitea_client.MiscellaneousApi(gitea_client.ApiClient(configuration))
body = gitea_client.MarkdownOption() # MarkdownOption |  (optional)
...
# create an instance of the API class
api_instance = gitea_client.MiscellaneousApi(gitea_client.ApiClient(configuration))
body = gitea_client.MarkupOption() # MarkupOption |  (optional)
