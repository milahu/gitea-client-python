...
# create an instance of the API class
api_instance = gitea_client.UserApi(gitea_client.ApiClient(configuration))
body = gitea_client.UserSettingsOptions() # UserSettingsOptions |  (optional)
...
body = gitea_client.CreateAccessTokenOption() # CreateAccessTokenOption |  (optional)
