...
### based on swagger-codegen

[github search: "This documentation describes the Gitea API." "This Python package is automatically generated" path:README.md](https://github.com/search?q=%22This+documentation+describes+the+Gitea+API.%22+%22This+Python+package+is+automatically+generated%22+path%3AREADME.md&ref=opensearch&type=code)

- https://github.com/BoYanZh/focs-gitea
  - https://pypi.org/project/focs-gitea/
- https://github.com/dcermak/py-gitea-opensuse-org
  - https://pypi.org/project/py-gitea-opensuse-org/

### written from scratch

- https://github.com/Langenfeld/py-gitea
  - https://pypi.org/project/py-gitea/
